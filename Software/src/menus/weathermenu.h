#ifndef WEATHER_MENU_STATE_HPP
#define WEATHER_MENU_STATE_HPP
...
class WeatherMenu : public MenuState
{
    // void loadapplication();

public:
    WeatherMenu(System* system);
...
WeatherMenu::WeatherMenu(System* system)
{
    menuPosition = 0;
    NUM_OPTIONS = 8;
    OPTIONS_PER_ROW = 4;
...
void WeatherMenu::draw(const float dt)
{
...
void WeatherMenu::update(const float dt) {}

void WeatherMenu::handleInput()
{
    char input;
