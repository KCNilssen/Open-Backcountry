#ifndef SENSORS_MENU_STATE_HPP
#define SENSORS_MENU_STATE_HPP
...
class SensorsMenu : public MenuState
{
    // void loadapplication();

public:
    SensorsMenu(System* system);
...
SensorsMenu::SensorsMenu(System* system)
{
    menuPosition = 0;
    NUM_OPTIONS = 8;
    OPTIONS_PER_ROW = 4;
...
void SensorsMenu::draw(const float dt)
{
...
void SensorsMenu::update(const float dt) {}

void SensorsMenu::handleInput()
{
    char input;
