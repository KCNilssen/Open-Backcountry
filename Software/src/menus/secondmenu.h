#ifndef SECOND_MENU_STATE_HPP
#define SECOND_MENU_STATE_HPP
...
class SecondMenu : public MenuState
{
    void loadapplication();
    int previousposition;

public:
    SecondMenu(System* system, int previousposition);
...
SecondMenu::SecondMenu(System* system, int pp)
{
    previousposition = pp;
    menuPosition = 0;
    NUM_OPTIONS = 8;
...
void SecondMenu::draw(const float dt)
{
...
void SecondMenu::update(const float dt) {}

void SecondMenu::handleInput()
{
    char input;
