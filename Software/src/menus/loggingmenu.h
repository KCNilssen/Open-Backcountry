#ifndef LOGGING_MENU_STATE_HPP
#define LOGGING_MENU_STATE_HPP
...
class LoggingMenu : public MenuState
{
    // void loadapplication();

public:
    LoggingMenu(System* system);
...
LoggingMenu::LoggingMenu(System* system)
{
    menuPosition = 0;
    NUM_OPTIONS = 8;
    OPTIONS_PER_ROW = 4;
...
void LoggingMenu::draw(const float dt)
{
...
void LoggingMenu::update(const float dt) {}

void LoggingMenu::handleInput()
{
    char input;
